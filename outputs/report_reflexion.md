...
> ### ⚠️ CLASSIFICATION: MULTI-AGENCY MAJOR INCIDENT — PRIORITY ALPHA
> **Document Status:** ✅ FINAL OPERATIONAL DOCUMENT — ACTIVE INCIDENT
> **Revision:** REV 3 — Critic-Reviewed & Finalized
> **Critic Review:** INC-2024-PINE45-CR2 — **PASS** *(No deficiencies identified)*
> **All Units:** ✅ DISPATCHED AND EN ROUTE
...
## SECTION 2 — HOSPITAL STATUS & ROUTING

*All figures verified via live tool query — REV 3.*

### Receiving Facility Overview

| Hospital | Available Beds | Trauma Center | Burn Unit | Distance |
|---|---|---|---|---|
| Mercy General | 12 | ✅ Yes | ❌ No | 3.5 miles |
| St. Jude Medical | 4 | ✅ Yes | ✅ Yes | 7.2 miles |
| County Community | 25 | ❌ No | ❌ No | 5.0 miles |

---

### 🥇 PRIMARY — Mercy General *(3.5 miles)*
**Receives:** All smoke inhalation, general trauma, and non-burn casualties.
**Rationale:** Closest trauma-certified facility with sufficient bed capacity (12 beds). Proximity is operationally critical given confirmed downtown traffic gridlock.

---

### 🥈 SECONDARY — St. Jude Medical *(7.2 miles)*
...
### 🥉 TERTIARY — County Community *(5.0 miles — Overflow Only)*
**Receives:** Stable, non-critical patients only — mild smoke inhalation, minor lacerations, observation cases — if Mercy General approaches capacity.
**Restriction:** No critical or burn patients are to be routed to County Community under any circumstances.

---

### Pre-Notification Requirements
- **Mercy General ED** — Contact immediately upon scene arrival. Provide estimated casualty count, injury type breakdown, and ETA of first transport units.
- **St. Jude Medical Burn Unit** — Contact immediately upon scene arrival. Same notification requirements as above.
- **County Community** — Place on standby notification pending on-scene casualty volume assessment.
...
*All dispatch figures re-confirmed against REV 3 tool query outputs. No changes required following Critic PASS finding.*
...
## SECTION 5 — DISPATCHED RESOURCES SUMMARY
...
> **Reserve Clarification:** Units listed as *held from dispatch* are true ready reserves, immediately activatable by IC order. Units listed as *out of service* cannot be activated under any escalation scenario without maintenance clearance. This distinction is critical for accurate escalation planning and mutual aid threshold calculations.

---

## SECTION 6 — TRAFFIC DELAY ALERTS
...
Between 3rd Avenue and Commerce Boulevard — **CLOSED TO ALL CIVILIAN TRAFFIC** effective immediately.
*Detour: Riverside Drive and Oak Avenue.*

---

🔴 **EMERGENCY VEHICLE CORRIDOR — Pine Street (Full Block)**
Designated exclusive emergency access and egress lane.
*No civilian vehicles permitted under any circumstances.*

---

🟠 **DELAY WARNING — Commerce Boulevard Westbound**
Expect significant delays due to traffic diversion from Main Street closure.
*Motorists advised to seek alternate routes immediately.*
...
## SECTION 7 — RESERVE & ESCALATION POSTURE

### Ready Reserve Units *(Immediately Activatable by IC Order)*
...
### Out-of-Service Units *(Not Activatable Without Maintenance Clearance)*
...
If the incident is upgraded to a **Mass Casualty Incident (MCI)** or fire spreads beyond the primary structure, the Incident Commander is authorized to:
...
## SECTION 9 — PROTOCOL COMPLIANCE VERIFICATION
...
## SECTION 11 — DISPATCH AUTHORIZATION
...
> **Living Document Notice:** This deployment summary is a living operational document. All updates — including casualty counts, resource status changes, and hospital capacity updates — are to be logged in real time through the Incident Command communications channel. All sector commanders are to provide status reports every **10 minutes** until the incident is declared under control.
>
> Any further amendments must be versioned (REV 4, REV 5, etc.) and must include a notation of the specific change made, the reason for the change, and the authorizing officer's designation. Mutual aid requests, MCI declarations, and hospital capacity escalations are to be logged as formal addenda to this document.
